...
class Buku extends CI_Controller
{
    ...
    public function ubahKategori() {
        ...
        $data['user'] = $this->ModelUser->cekData(['email' => $this->session->userdata('email')])->row_array();
        $data['kategori'] = $this->ModelBuku->kategoriWhere(['id_kategori' => $this->uri->segment(3)])->row_array();
        ...
        if ($this->form_validation->run() == false) {
           ...
           $update_data = [
                'nama_kategori' => $this->input->post('kategori', true),  // Menggunakan 'nama_kategori' sesuai dengan nama kolom dalam tabel
           ];
           $this->ModelBuku->updateKategori($update_data, ['id_kategori' => $this->input->post('id_kategori')]);
